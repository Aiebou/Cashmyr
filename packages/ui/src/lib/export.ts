import { indexOf, type Cents, type Dataset, type OpType } from "@cashmyr/core";
import { BUCKET_LABELS } from "./data";

/** Colonnes de l'export de l'ancienne application, colonne Dette comprise. */
export const CSV_HEADER = ["Date", "Type", "Categorie", "Usage", "Compte", "Vers", "Objectif", "Dette", "Libelle", "Montant"] as const;
 ...
 * Les noms sont ceux du moment, y compris pour un élément supprimé depuis.
 */
